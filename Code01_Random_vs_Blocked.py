...
# Plot the noise vulnerability test results
# retention
plt.figure()
plt.plot(loss_retention_noisy_array_blocked.mean(axis=0), label='Blocked')
plt.plot(loss_retention_noisy_array_random.mean(axis=0), label='Random')
plt.xlabel('Number of Noisy Retraining')
plt.ylabel('Retention Loss with Noisy Weights')
plt.legend()
plt.title('Vulnerability Test - Retention Loss')
plt.show()

# test
plt.figure()
plt.plot(loss_test_noisy_array_blocked.mean(axis=0), label='Blocked')
plt.plot(loss_test_noisy_array_random.mean(axis=0), label='Random')
plt.xlabel('Number of Noisy Retraining')
plt.ylabel('Test Loss with Noisy Weights')
plt.legend()
plt.title('Vulnerability Test - Test Loss')
plt.show()

# Plot the pruning vulnerability test results
# retention
plt.figure()
plt.plot(loss_retention_pruned_array_blocked.mean(axis=0), label='Blocked')
plt.plot(loss_retention_pruned_array_random.mean(axis=0), label='Random')
plt.xlabel('Percentage of Weights Pruned')
plt.ylabel('Retention Loss with Pruned Weights')
plt.legend()
plt.title('Pruning Vulnerability Test - Retention Loss')
plt.show()

# test
plt.figure()
plt.plot(loss_test_pruned_array_blocked.mean(axis=0), label='Blocked')
plt.plot(loss_test_pruned_array_random.mean(axis=0), label='Random')
plt.xlabel('Percentage of Weights Pruned')
plt.ylabel('Test Loss with Pruned Weights')
plt.legend()
plt.title('Pruning Vulnerability Test - Test Loss')
plt.show()

# Plot the interference vulnerability test results
# retention
plt.figure()
plt.plot(loss_retention_interf_array_blocked.mean(axis=0), label='Blocked')
plt.plot(loss_retention_interf_array_random.mean(axis=0), label='Random')
plt.xlabel('Number of Interfering Retraining')
plt.ylabel('Retention Loss with Interfering Weights')
plt.legend()
plt.title('Interference Vulnerability Test - Retention Loss')
plt.show()
# test
plt.figure()
plt.plot(loss_test_interf_array_blocked.mean(axis=0), label='Blocked')
plt.plot(loss_test_interf_array_random.mean(axis=0), label='Random')
plt.xlabel('Number of Interfering Retraining')
plt.ylabel('Test Loss with Interfering Weights')
plt.legend()
plt.title('Interference Vulnerability Test - Test Loss')
plt.show()
